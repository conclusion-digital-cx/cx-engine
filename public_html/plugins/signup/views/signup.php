            ...
            <div class="layout align-center justify-center pa-2" style="min-height: 100%;">
              <div class="flex xs12 sm8 md4">
                <form @submit.prevent="submit(form)" novalidate="novalidate" class="v-form">
                  <!-- <form @submit.prevent="submit" novalidate="novalidate" class="v-form" method="POST" action="/signup"> -->
                ...
                <div class="text-center mt-5"><a href="/login" class="">
                    Already an account? Go to the login page
                  </a></div>
              </div>
            </div>
            <!---->
