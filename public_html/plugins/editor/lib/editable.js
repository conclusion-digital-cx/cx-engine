...
Array.prototype.move || Object.defineProperty(Array.prototype, 'move', {
  value: function (index, howMany, toIndex) {
    ...
    var toIndex = parseInt(toIndex) || 0
    var toIndex = toIndex < 0 ? array.length + toIndex : toIndex
    var toIndex = toIndex <= index ? toIndex : toIndex <= index + howMany ? index : toIndex - howMany
    var moved
